...
tsne_cap <- fig_cap(name='tSNE', caption = 'Tissue - tissue consistent two-dimensional sample - sample transcriptome profiles demonstrate effective quality control and sample processing')
...
regulartable(gtex) %>% width(width = c(0.5,1,0.5,5)) %>% flextable::align(align='center')
#Output Caption
