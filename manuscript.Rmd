...
While organoid and retina tissues are highly similar at a pan-transcriptome level, differential expression analysis between organoid and fetal retina reveals differences in related groups of genes. We  Analysis of broad trends in GO term enrichment between differentially expressed genes shows that the HOXB family and protocadherins are differentially expressed between fetal retina and organoids. We noticed that several BRN3/POU4F genes were also differentially regulated
...
organoid_fetal_GO %>% filter(ID %in% c('GO:0001503','GO:0031589','GO:0050878','GO:0061448','GO:0050678','GO:0030335','GO:0030198', 'GO:0007156', 'GO:0050769', 'GO:0030099')) %>% mutate(geneID = gsub('<br>', ' ', geneID)) %>% as_tibble() %>% regulartable() %>% 
  flextable::align(align='center') %>% 
  font(fontname = 'Linux Libertine O', part = 'all')
#Output Caption (* * for italics)
cat(paste0("\n*",GOterm_cap,"*\n"))
