...
tissueCountsBarPlot_cap <- fig_cap(name='tissueCountsBarPlot', caption =  paste0('Substantial increase in eye tissue count and type from 2017 (', core_tight_2017 %>% filter(study_accession != 'SRP012682') %>% nrow(), ', lighter color) to 2019 (', core_tight_2019 %>% filter(Kept=="Kept", study_accession != 'SRP012682') %>% nrow(),', darker color) EiaD. We also improved the metadata labelling, the cornea samples (yellow) now delineates endothelial and epithelial tissues and the retina samples (orange) distinguish retina organoid and retinal ganglion cell (RGC) from stem cells.'))
