...
To calculate pearson correlation ($R^2$) between GTEx-calculated TPM gene values and our GTEx TPM gene values, we downloaded "GTEx_Analysis_2016-01-15_v7_RNASeQCv1.1.8_gene_tpm.gct.gz" and matched against our GTEx TPM values, running the pearson correlation with $log2(TPM + 0.01)$ values as per Zhang et al. with the cor function in R [@zhangEvaluationComparisonComputational2017].
