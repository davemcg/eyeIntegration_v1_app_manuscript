...
All quantification of expression happens at the transcript level. As most people think in terms of gene expression, we collapse all of the transcript level information information into a gene. Very briefly, the expression from each transcript of a gene is averaged, with scaling for the length of the transcript. If there are transcripts (of equal length) a1 (5 counts), a2 (6 counts), and a3 (7 counts) for gene a, then gene a would have an expression of (5 + 6 + 7) / 3. 
