...
Zhang et al. (https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-017-4002-1) report a pearson cor R^2 with TPM of 0.89 and 0.93 between alignment free (salmon/kallisto) methods compared to alignment-based methods (STAR/REM) [@zhangEvaluationComparisonComputational2017]. As GTEx used an alignment-based approach (and a different reference genome - we use GRCh38, GTEx uses GRCh37) and we length scale our TPM values (GTEx does note) we feel that this is a reasonable result. 

We have added a section to our methods and results section discussing this briefly (lines 126-129, 227-233). 
...
We have added a "limitations" section to the resulst section of the manuscript:
