...
```
We have reduce the number of panels in Figure 4 to two and moved the remaining panels to a supplementary figure.

Figure 5 has been split into two separate figures. 
...
Supplmental table 2 is unnecessarily confusing. There are no differences between the "gene type" whether at the gene or transcript level. We have added the Gencode description of the biotypes to the table and given the counts as "Gene Counts" or "Transcript Counts" for each biotype. 
...
We originally had 63 tissues - several were removed as they had an insufficient number of samples after quality control. I've updated the text for this figure legend to reflect the final number (58). 
...
There are 33 total clustesr. We have added a supplementary table summarizing the Sub Tissue composition of each one. 
